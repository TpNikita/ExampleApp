...
inline fun <reified T : ComponentDependencies> Fragment.findRouterDependencies(): T {
    return findRouterDependenciesProvider()[T::class.java] as T
}
...
fun Fragment.findRouterDependenciesProvider(): ComponentDependenciesProvider {
    val hasDaggerProviders = when {
